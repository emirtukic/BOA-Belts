    ...
    <main className="bg-white text-[#1f1f1f]">
      ...
      <section className="py-16 px-6 bg-white border-b border-[#ececec]">
        <div className="max-w-4xl mx-auto space-y-6">
          <h2 className="text-3xl font-semibold text-[#1f1f1f]">{data.storyTitle}</h2>
      ...
      <section className="py-16 px-6 bg-white border-b border-[#ececec]">
        <div className="max-w-4xl mx-auto space-y-6">
          <h2 className="text-3xl font-semibold text-[#1f1f1f]">{data.craftTitle}</h2>
          {data.craftParagraphs.map((paragraph) => (
            <p key={paragraph} className="text-lg leading-relaxed text-[#4b4b4b]">
              {paragraph}
            </p>
          ))}
      ...
      <section className="py-16 px-6 bg-white border-b border-[#ececec]">
        <div className="max-w-3xl mx-auto space-y-6">
          <h2 className="text-3xl font-semibold text-center text-[#1f1f1f]">{data.timelineTitle}</h2>
          <ul className="list-disc list-inside space-y-3 text-[#4b4b4b]">
            {data.timelinePoints.map((item) => (
              <li key={item}>{item}</li>
            ))}
          </ul>
        </div>
