      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="text-sm space-y-2 text-[#777]">
            <li><Link href="/kaisevi" className="hover:text-[#111] transition-colors">{t.nav.belts}</Link></li>
            <li><Link href="/torbe" className="hover:text-[#111] transition-colors">{t.nav.bags}</Link></li>
            <li><Link href="/novcanici" className="hover:text-[#111] transition-colors">{t.nav.wallets}</Link></li>
        ...
        <div>
          ...
          <ul className="text-sm space-y-2 text-[#777]">
            <li><Link href="/o-nama" className="hover:text-[#111] transition-colors">{t.nav.about}</Link></li>
            <li><Link href="/lojalnost" className="hover:text-[#111] transition-colors">{t.nav.loyalty}</Link></li>
          </ul>
        </div>
